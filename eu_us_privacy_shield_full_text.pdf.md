...
Internet Service Providers (“ISPs”), telecommunications carriers, and
...
The panel will provide such advice in response to
...
An individual has the right to obtain confirmation of whether
...
Independent recourse mechanisms must publish an annual
...
Engagement With EU DPAs and Enforcement Cooperation
...
Google, Facebook, Twitter, Microsoft, Wyndham, Oracle, HTC, and Snapchat, as well as lesserknown companies. The FTC has sued businesses that allegedly spammed consumers, installed
...
Any entity that fails to comply with an FTC order is subject to a civil penalty of up to $16,000 per violation, or
$16,000 per day for a continuing violation. See 15 U.S.C. § 45(l); 16 C.F.R. § 1.98(c).
2
Congress has expressly affirmed the FTC’s authority to seek legal remedies, including restitution, for any acts or
...
Act, and over 20 actions enforcing the Children’s Online Privacy Protection Act (“COPPA”). 3
...
children’s personal information. The FTC also issued two rules implementing the GrammLeach-Bliley Act – the Privacy Rule and the Safeguards Rule – which require financial

3

In some instances, the Commission’s privacy and data security cases allege that a company engaged in
...
4
See, e.g., Press Release, Fed. Trade Comm’n, FTC Warns Children’s App Maker BabyBus About
Potential COPPA Violations (Dec. 22, 2014), https://www.ftc.gov/news-events/pressreleases/2014/12/ftc-warns-childrens-app-maker-babybus-about-potential-coppa; Press Release, Fed.
Trade Comm’n, FTC Warns Data Broker Operations of Possible Privacy Violations (May 7, 2013),
https://www.ftc.gov/news-events/press-releases/2013/05/ftc-warns-data-broker-operations-possibleprivacy-violations; Press Release, Fed. Trade Comm’n, FTC Warns Data Brokers That Provide Tenant
Rental Histories They May Be Subject to Fair Credit Reporting Act (Apr. 3, 2013),
https://www.ftc.gov/news-events/press-releases/2013/04/ftc-warns-data-brokers-provide-tenant-rentalhistories-they-may.
5
See U.S. Dep’t of Commerce, Safe Harbor Enforcement Overview,
https://build.export.gov/main/safeharbor/eu/eg main 018481.
6
For a more comprehensive summary of the legal protections in the United States, see Daniel J. Solove &
Paul Schwartz, Information Privacy Law (5th ed. 2015).

2

institutions 7 to make disclosures about their information sharing practices and to implement a
...
Financial institutions are defined very broadly under the Gramm-Leach-Bliley Act to include all
...
8
Under the Consumer Financial Protection Act of 2010 (“CFPA”), Title X of Pub. L. 111-203, 124 Stat.
...
Financial Protection Bureau (“CFPB”). The FTC retains enforcement authority under the Gramm-LeachBliley Act as well as rulemaking authority for the Safeguards Rule and limited rulemaking authority
under the Privacy Rule with respect to auto dealers.
9
Under the CFPA, the Commission shares its FCRA enforcement role with the CFPB, but rulemaking
...
11
See, e.g., American Recovery & Reinvestment Act of 2009, Pub. L. No. 111-5, 123 Stat. 115 (2009)
and relevant regulations, 45 C.F.R. §§ 164.404-164.414; 16 C.F.R. pt. 318.
12
See, e.g., National Conference of State Legislatures (“NCSL”), State Security Breach Notification Laws
(Jan. 4, 2016), available at http://www.ncsl.org/research/telecommunications-and-informationtechnology/security-breach-notification-laws.aspx .
13
NCSL, Data Disposal Laws (Jan. 12, 2016), available at
http://www.ncsl.org/research/telecommunications-and-information-technology/data-disposal-laws.aspx .

3

Track practices, 14 a “Shine the Light” law requiring greater transparency for data brokers, 15 and
...
pay a $5 million settlement to resolve a class action involving alleged inadequate deidentification related to the release of search queries of hundreds of thousands of AOL members.
...
17
See Jay Cline, U.S. Takes the Gold in Doling Out Privacy Fines, Computerworld (Feb. 17, 2014),
available at
...
▶ The FTC approved final orders with health billing company PaymentsMD, LLC, and its former CEO,
...
gift cards and other items. The defendant promised consumers that the downloaded app would be
...
requirements. The FTC also asserts that from at least January 2012 through December 2014, LifeLock
...
U.S. and EU officials are currently discussing the development of an enhanced mechanism that protects
...
services” and “card member services.” The defendants charged consumers up to $4,999 for their nonexistent services.
...
used deception, threats, and intimidation to induce elderly consumers to pay for medical alert systems
...
to take first. It has detailed advice and helpful resources, including easyto-print checklists and sample letters. The site also helps users connect to
...
Privacy Enforcement Network (GPEN), an informal network of 59 privacy agencies that promotes crossborder cooperation. In addition to the FTC, the initial participants in the GPEN Alert system are: the
...
This paper discusses federal law enforcement and regulatory authorities; violations of state law are investigated by
...
trap-and-trace provisions, law enforcement may obtain a court order to acquire real-time, noncontent dialing, routing, addressing, and signaling information about a phone number or email
...
DOJ Guidelines and Policies: In addition to these Constitutional, statutory, and rulebased limitations on government access to data, the Attorney General has issued guidelines that
place further limits on law enforcement access to data, and that also contain privacy and civil

4
liberty protections. For instance, the Attorney General's Guidelines for Domestic Federal
...
United States -- whether the information concerns U.S. persons or citizens of foreign countries -and in addition permits judicial review of any government requests for data pursuant to these
authorities.
